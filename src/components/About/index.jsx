  ...
  <div className={cx(styles.root, className)}>
    ...
    <div className={styles.content}>
      <p>
        ...
        logical, software side and the visual, user-facing side of your website.
      </p>
      ...
      <p>
        ...
        Afterwards, I developed a Training Website for the company I was working
        for. This site focused on delivering and tracking employee training
        using the various technologies I learned through Thinkful, mainly using
