export const projects = [
  {
    ...
    tools: ["Python", "scikit-learn", "XGBoost", "Public Data"],
  ...
  },
  {
    ...
    tools: ["Python", "XGBoost", "AWS SageMaker"],
  ...
  },
  {
    ...
    tools: ["Python", "Data Pipelines", "Public Data"],
  ...
  },
  {
    ...
    tools: ["Python", "NLP", "Topic Modeling"],
  ...
  },
  {
    ...
    tools: ["Python", "Modeling", "Clinical Data"],
    href: "https://github.com/junclemente/heart-disease-prediction-multi-cohort",
  },
  {
    title: "jcds - Exploratory Data Analysis Toolkit",
    description:
